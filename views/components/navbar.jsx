    ...
    return (
        ...
        <div id="nav_wrapper">
            <div className="nav_left">
                ...
                <a href="/dashboard" ><div className="nav_button">My Dashboard</div></a>
                <a href="/gallery/addphoto"><div className="nav_button"><box-icon name='plus-circle' type='solid' color='#ffffff' ></box-icon>Add Photos</div></a>
